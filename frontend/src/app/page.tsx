...
function CircularMarquee({ progress }: { progress: number }) {
  const srcs = [
    "/images/orbit/orbit-1.jpg",
    "/images/orbit/orbit-2.jpg",
    "/images/orbit/orbit-3.jpg",
    "/images/orbit/orbit-4.jpg",
    "/images/orbit/orbit-5.jpg",
    "/images/eyes-on-img.jpg",
    "/images/hero-bg.jpg",
    "/images/orbit/orbit-1.jpg", // Duplicate some to fill out the orbit if needed, or stick to 8 unique
  ];
...
export default function Home() {
  ...
  return (
    <div className={`bg-black min-h-screen text-white relative selection:bg-white/20 transition-opacity duration-1000 ${hasEntered ? "opacity-100 overflow-visible" : "opacity-100 overflow-hidden h-screen"}`}>
      ...
      >
        <iframe
          src="https://www.youtube.com/embed/UjEngEpiJKo?autoplay=1&mute=1&controls=0&loop=1&playlist=UjEngEpiJKo&showinfo=0&rel=0&modestbranding=1&playsinline=1&cc_load_policy=3&iv_load_policy=3&disablekb=1"
              ...
              <>
                ...
                >
                  ...
                  >
                    ...
                    <img src="/images/orbit/orbit-1.jpg" alt="" className="h-[0.75em] w-[1.2em] object-cover inline-block align-middle mx-6 opacity-100" style={{ borderRadius: "0.2em" }} />
                    <span className="font-normal tracking-wide">Old age should burn and rave at close of day</span>
                    <img src="/images/orbit/orbit-2.jpg" alt="" className="h-[0.75em] w-[1.2em] object-cover inline-block align-middle mx-6 opacity-100" style={{ borderRadius: "0.2em" }} />
                    <span className="font-normal tracking-wide">Rage</span>
                    <img src="/images/orbit/orbit-3.jpg" alt="" className="h-[0.75em] w-[1.2em] object-cover inline-block align-middle mx-6 opacity-100" style={{ borderRadius: "0.2em" }} />
                    <span className="font-normal tracking-wide">rage against the dying of the light</span>
                    <img src="/images/orbit/orbit-4.jpg" alt="" className="h-[0.75em] w-[1.2em] object-cover inline-block align-middle mx-6 opacity-100" style={{ borderRadius: "0.2em" }} />
                    <img src="/images/orbit/orbit-5.jpg" alt="" className="h-[0.75em] w-[1.2em] object-cover inline-block align-middle mx-6 opacity-100" style={{ borderRadius: "0.2em" }} />
                  </h2>
                </div>
              </>
            );
